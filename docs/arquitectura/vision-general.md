...
### AI Material Renamer
1. Escaneo local de materiales.
2. Solo los casos con problemas se envían a OpenRouter.
3. Propuestas se guardan en `Scene.lime_ai_mat.rows`.
4. Apply renombra respetando reglas MAT_ y versiones.
