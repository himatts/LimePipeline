...
- Incluye un AI Asset Organizer v2 para sugerir y aplicar nombres de objetos/materiales/colecciones (OpenRouter), con preview de cambios, organización opcional de colecciones y relink opcional de texturas afectadas.
